  ...
  return (
    <div className=" relative">
      ...
      <div className="mx-auto max-w-2xl mt-64 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4">
            ...
            <h4 className="text-offwhite text-sm font-normal mb-6 flex gap-2"><Image src={'/images/Footer/number.svg'} alt="number-icon" width={20} height={20} /> <a href="tel:+541149273445">(+54)9 11 4927 3445</a></h4>
            <h4 className="text-offwhite text-sm font-normal mb-6 flex gap-2"><Image src={'/images/Footer/email.svg'}  alt="email-icon" width={20} height={20} /> <a href="mailto:thebetancourtdev@gmail.com">thebetancourtdev@gmail.com</a></h4>
            <h4 className="text-offwhite text-sm font-normal mb-6 flex gap-2"><Image src={'/images/Footer/address.svg'} alt="address-icon" width={20} height={20} />Buenos Aires - Argentina</h4>
          </div>
      ...
      <div className='py-8 px-4 border-t border-t-lightblue'>
        <h3 className='text-center text-offwhite'>@2023 - All Rights Reserved by <Link href="https://wa.me/message/QGHZSFPLSP4ZD1" target="_blank">Betancourt Dev</Link></h3>
      </div>
